...
if(class_exists("kit_authemail")) return;

Class kit_authemail extends CModule
{
    var $MODULE_ID = "kit.authemail";
    var $MODULE_VERSION;
    ...
    function kit_authemail(){
        ...
        $this->MODULE_NAME = GetMessage("KIT_MODULE_NAME_AUTHEMAIL");
        $this->MODULE_DESCRIPTION = GetMessage("KIT_MODULE_DESCRIPTION_AUTHEMAIL");
